              ...
              <div className={styles.container_checkbox}>
                <div className={styles.container_input}>
                  ...
                  <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                    <rect width="16" height="16" rx="2.66667" fill="#F95B17" />
                    <path d="M12.4284 5L6.14274 11.2856L3.28564 8.42852" />
                  </svg>
                </div>
                <label htmlFor="">
                  Lorem ipsum dolor sit amet consectetur. In etiam enim sed
                  velit consequat tellus. In{" "}
                  <span className={styles.underline}>etiam</span> enim sed velit
                  consequat tellus.
                </label>
              </div>
            </form>
        ...
        <div className={styles.foot}>
          ...
          <div className={styles.container_join_us}>
            <div className={styles.container_title_sn}>
              ...
              <div className={styles.container_sn}>
